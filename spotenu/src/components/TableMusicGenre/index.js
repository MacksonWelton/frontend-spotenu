...
function TableMusicGenreHead(props) {
...
const TableMusicGenreToolbar = (props) => {
...
TableMusicGenreToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
};

const TableMusicGenre = (props) => {
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <TableMusicGenreToolbar numSelected={selected.length} />
        <TableContainer>
          <Table
...
export default TableMusicGenre;